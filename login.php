...
if (isset($_POST['submit'])) {
    // Sanitizando e escapando os inputs
...
<body class="bg-gradient-to-r from-primary to-second font-roboto dark:from-gray-950 dark:to-gray-800">
    ...
    <main class="bg-white dark:bg-gray-800 max-w-lg mx-auto my-32 p-8 md:p-12 rounded-lg shadow-2xl">
        <section>
            <h3 class="font-semibold text-2xl font-roboto dark:text-white">Bem-vindo a <em class="font-bold text-primary">Dash</em></h3>
            <p class="text-gray-600 text-lg pt-2 font-roboto font-medium dark:text-white">Entre na sua conta.</p>
        </section>
        ...
        <section class="mt-10">
            <form action="" method="post" class="flex flex-col">
                <div class="mb-6 rounded bg-gray-200">
                    <label class="block text-gray-700 text-sm font-bold mb-2 ml-3">Login</label>
                    <input type="text" name="login" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-black transition duration-500 px-3 pb-3" maxlength="6"  required> 
                </div>
                <div class="mb-3 rounded bg-gray-200">
                    <label class="block text-gray-700 text-sm font-bold mb-2 ml-3">Senha</label>
                    <input type="password" name="password" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-300 focus:border-black transition duration-500 px-3 pb-3" maxlength="8" required>
                </div>
                <div class="flex justify-end">
                    <a href="atlsenha.php" class="text-lg font-medium font-bebas  dark:hover:text-primary dark:text-white hover:underline my-6">Alterar minha senha</a>
                </div>
                <section class="flex flex-col mb-2">
                    <button class="bg-primary w-full hover:bg-black hover:scale-105 hover:transform hover:text-white font-bold font-bebas py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit" name="submit">Entrar</button>
                </section>
                ...
                <div class="flex justify-center">
                    <a href="cadastro.php" class="text-lg font-medium font-bebas hover:text-primary dark:hover:text-primary dark:text-white hover:underline my-6">Criar uma conta</a>
                </div>
            </form>
        </section>
    </main>
